...
// Spotify requires HTTPS for redirect URIs. Cert files are generated by mkcert:
//   mkcert -install && mkcert localhost
// The resulting localhost.pem / localhost-key.pem are the defaults below.
...
try {
	...
	console.error(`TLS certificate files not found (${certPath}, ${keyPath})`);
	console.error('Generate them with: mkcert -install && mkcert localhost');
	process.exit(1);
}
